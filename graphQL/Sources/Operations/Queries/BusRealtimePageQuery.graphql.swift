  ...
  public struct Data: GraphQL.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("bus", [Bus].self, arguments: [
        "id_": [216000138, 216000759, 216000381, 216000117, 216000379, 216000383, 216000070, 216000719],
    ...
    public struct Bus: GraphQL.SelectionSet {
      ...
      public struct Route: GraphQL.SelectionSet {
        ...
        public struct Realtime: GraphQL.SelectionSet {
          ...
          public static var __parentType: any ApolloAPI.ParentType { GraphQL.Objects.BusRealtimeQuery }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
