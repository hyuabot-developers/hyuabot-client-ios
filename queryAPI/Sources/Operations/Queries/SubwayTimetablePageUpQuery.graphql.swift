...
public class SubwayTimetablePageUpQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query SubwayTimetablePageUpQuery($station: String!) { subway(id_: [$station]) { __typename timetable { __typename up { __typename weekdays time hour minute terminal { __typename id } } } } }"#
    ))
